<img alt="MVC" title="MVC" src="/douglasneves-net/Boilerplate-NodeJS-MVC/raw/master/git/mvc.png" width="100%" style="max-width: 100%;">
...
```javascript
yarn add express-session connect-mongo connect-flash
```
